...
BenchmarkTools.Trial: 1523 samples with 1 evaluation.
 Range (min … max):  3.059 ms …   6.138 ms  ┊ GC (min … max): 0.00% … 38.28
%
 Time  (median):     3.171 ms               ┊ GC (median):    0.00%
 Time  (mean ± σ):   3.278 ms ± 456.147 μs  ┊ GC (mean ± σ):  2.65% ±  7.70
%

  ▃▇█▇▅▂                                                    ▁  
  ██████▇▆▆▆▆▄▄▅▄▄▁▇▆▆▄▄▄▁▁▁▁▁▄▁▁▁▁▁▁▁▁▁▁▁▁▁▁▄▁▁▁▁▁▁▁▁▄▁▄▇█▇█ █
  3.06 ms      Histogram: log(frequency) by time      5.41 ms <

 Memory estimate: 1.84 MiB, allocs estimate: 1823.
```
...
BenchmarkTools.Trial: 51 samples with 1 evaluation.
 Range (min … max):  97.616 ms … 105.975 ms  ┊ GC (min … max): 0.00% … 0.00
%
 Time  (median):     99.281 ms               ┊ GC (median):    1.48%
 Time  (mean ± σ):   99.405 ms ±   1.610 ms  ┊ GC (mean ± σ):  1.11% ± 0.65
%

               ▇▄█                                              
  ██▅▁▃▃▁▁▁▁▁▁▅███▆▅▃▁▁▁▁▁▁▃▁▁▁▁▁▁▁▁▃▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▃▁▁▁▁▁▃ ▁
  97.6 ms         Histogram: frequency by time          105 ms <

 Memory estimate: 33.36 MiB, allocs estimate: 4202.
```
...
BenchmarkTools.Trial: 34 samples with 1 evaluation.
 Range (min … max):  142.884 ms … 163.043 ms  ┊ GC (min … max): 5.02% … 7.0
8%
 Time  (median):     148.638 ms               ┊ GC (median):    8.53%
 Time  (mean ± σ):   149.106 ms ±   3.375 ms  ┊ GC (mean ± σ):  8.43% ± 1.4
0%

               ▃  ▃█▃▁                                           
  ▄▁▄▁▄▁▁▁▁▁▁▁▁█▁▇████▄▄▁▄▄▁▁▁▁▁▁▁▄▇▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▄ ▁
  143 ms           Histogram: frequency by time          163 ms <
...
BenchmarkTools.Trial: 10000 samples with 1 evaluation.
 Range (min … max):  14.300 μs …  3.193 ms  ┊ GC (min … max): 0.00% … 89.76
%
 Time  (median):     16.300 μs              ┊ GC (median):    0.00%
 Time  (mean ± σ):   17.898 μs ± 53.335 μs  ┊ GC (mean ± σ):  4.76% ±  1.61
%

      ▅█▅▃                                                     
  ▂▂▃▇████▆▄▄▅▄▃▃▃▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▂▁▂▂▁▂▂▁▁▂▂▂▂▂▂▂▂▂▂ ▃
  14.3 μs         Histogram: frequency by time        33.5 μs <
...
BenchmarkTools.Trial: 3637 samples with 1 evaluation.
 Range (min … max):  1.311 ms …   7.618 ms  ┊ GC (min … max): 0.00% … 76.42
%
 Time  (median):     1.346 ms               ┊ GC (median):    0.00%
 Time  (mean ± σ):   1.372 ms ± 208.132 μs  ┊ GC (mean ± σ):  1.12% ±  4.95
%

  ▂▇█▇▆▂                                                      ▁
  ██████▆▅▄▁▅▅▇█▇▇▆▆▆▅▃▁▃▃▁▁▁▃▁▁▃▁▁▁▃▁▄▁▁▁▁▄▃▃▃▁▁▁▅▄▄▃▅▃▁▃▄▁▄ █
  1.31 ms      Histogram: log(frequency) by time      2.03 ms <
...
```plaintext
BenchmarkTools.Trial: 10000 samples with 1 evaluation.
 Range (min … max):  172.701 μs … 418.001 μs  ┊ GC (min … max): 0.00% … 0.0
0%
 Time  (median):     175.701 μs               ┊ GC (median):    0.00%
 Time  (mean ± σ):   176.719 μs ±   4.330 μs  ┊ GC (mean ± σ):  0.00% ± 0.0
0%

      ▁▂ ▄▇█▁▃     ▁                                             
  ▁▂▅▅██▇██████▅▇█▆█▇▆▄▄▃▂▃▂▂▂▂▂▂▂▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▁▂▁▁▁▁▁▁▁▁▁▁▁▁ ▃
  173 μs           Histogram: frequency by time          189 μs <
