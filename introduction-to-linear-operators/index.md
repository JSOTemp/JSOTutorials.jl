...
10-element Vector{ComplexF64}:
  0.9975647446888104 - 0.0im
  0.5920956716606222 - 0.0im
 0.00737607445211288 - 0.0im
  0.6437981233990908 - 0.0im
 0.19991684533823478 - 0.0im
   0.445208667527693 - 0.0im
  0.7928641886988415 - 0.0im
 0.22062093856730614 - 0.0im
 0.28915447653804643 + 0.0im
  0.8584053417322622 - 0.0im
```
...
```plaintext
ex = InexactError(:Float64, Float64, -0.8593427355329031 - 1.40104899519676
44im)
```
