...
10-element Vector{ComplexF64}:
  0.7257123900794117 - 0.0im
  0.9686173941682761 - 0.0im
   0.138050270420878 - 0.0im
  0.4360778621421201 - 0.0im
  0.8984441576227828 - 0.0im
 0.31648401334127557 - 0.0im
  0.9843039280107219 - 0.0im
  0.8857114644344058 - 0.0im
  0.7615873045517857 + 0.0im
  0.7565363266933094 - 0.0im
```
...
```plaintext
ex = InexactError(:Float64, Float64, 0.8862815907036233 + 0.622809168343350
4im)
```
