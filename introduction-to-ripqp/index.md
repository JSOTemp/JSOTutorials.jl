...
-12]
  ...
  iterations: 16
  elapsed time: 12.561660051345825
  solver specific:
    nvar_slack: 3
...
──────
                               ...
                               ───────────────────────   ──────────────────
──────
       Tot / % measured:            2.61s /  47.8%            207MiB /  48.
3%    
 ...
 ──────────────────────────────────────────────────────────────────────────
──────
 ripqp                      1    1.25s  100.0%   1.25s    100MiB  100.0%   
100MiB
   ~ripqp~                  1    1.25s   99.9%   1.25s    100MiB   99.9%   
100MiB
   allocate workspace       1   87.9μs    0.0%  87.9μs   5.73KiB    0.0%  5
.73KiB
   init solver              1   57.8μs    0.0%  57.8μs   3.93KiB    0.0%  3
.93KiB
   display                  5    589μs    0.0%   118μs   51.0KiB    0.0%  1
0.2KiB
   update solver            4   21.3μs    0.0%  5.33μs      960B    0.0%   
  240B
   solver aff               4   1.90μs    0.0%   475ns     0.00B    0.0%   
 0.00B
   solver cc                4   1.00μs    0.0%   250ns     0.00B    0.0%   
 0.00B
 ──────────────────────────────────────────────────────────────────────────
──────
```
